...
(function() {
  ...
  const translations = {
    de: {
      ...
      'settings.openaiDescription': 'Geben Sie Ihren OpenAI API-Schlüssel unten ein. Er wird lokal in Ihrem Browser gespeichert und für die Qualitätsanalyse von Papern verwendet.',
    ...
    en: {
      ...
      'settings.openaiDescription': 'Enter your OpenAI API key below. It will be stored locally in your browser and used for paper quality analysis.',
